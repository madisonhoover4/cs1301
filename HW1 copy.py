...
print("The area of a circle with radius {} is {}.".format(radius, round(area, 2)))
...
print("Since you have {} chicken(s), {} tarantula(s), and {} horse(s), you have a farm with {} legs.".format(numchicken, numtarantula, numhorse, sumfarm) )
...
print("A person with a weight of {} pounds and a height of {} inches has a bmi of {}.".format(weightlb, heightin, bmi) )
...
print("With ${}, you can buy {} chicken wing(s), {} taquito(s), {} coke(s), {} chip(s), and {} mint(s).".format(money, chxwings, taquitos, coke, chips, mints)
...
rate = input("What is your nominal interest rate (as a decimal)?")
rate = float(rate)
...
finalamt = initial * ((1 + (rate / numcomp)) ** (numcomp*numyears))
print(finalamt)
